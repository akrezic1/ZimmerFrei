...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            Fragment fragment =  LoginOrRegisterFragment.newInstance(1);
        ...
        if (!checkPlayServices()){
            Toast.makeText(this, R.string.no_play_services, Toast.LENGTH_SHORT).show();
        } else {
    ...
    private String getRegistrationId(Context context) {
        final SharedPreferences prefs = SharedPrefsHelper.getGCMPreferences(context);
